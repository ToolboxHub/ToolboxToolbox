function [toolboxes, subdirs, functionNames, unresolved, pList] = tbDependencies(filename)
...
%                    installed toolboxes.
%    pList         - product-list ase returned by Matlab's
...
%% Input validation
parser = inputParser();
parser.addRequired('filename',@isstr)
